# -*- coding: utf-8 -*-
"""Mobius Strip Surface Modeling

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NEjoVw2GNezsNfns2j59_MrnNyJXjzjf

# Möbius Strip 3D Modeling and Geometric Property Calculation

## Author: KARTHIKEYA REDDY BOMMIREDDY
Date: 27-May-2025

## Description:
This script models a Möbius strip using parametric equations, computes
its surface area and edge length numerically, and visualizes
the 3D strip using matplotlib.
